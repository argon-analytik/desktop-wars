...
import { FloppyDiskIcon, WatchdogIcon } from '../ui/GameIcons.jsx';
    ...
    >
          ...
          <SpriteSheet
            ...
            fallback={
              <Sprite
                ...
                fallback={<WatchdogIcon size={spriteSize} style={{ filter: spriteFilter }} />}
              />
            }
          />
        </div>
      ...
      {type === 'sticky' && (
        <Sprite
          ...
          fallback={<FloppyDiskIcon size={spriteSize} style={{ filter: spriteFilter }} />}
        />
      )}
    </div>
  );
